...
import com.james.myblog.dao.BlogConfigMapper;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String yourEmail = "1625589073@qq.com";
    public static final String yourName = "James";

    public static final String footerAbout = "your personal blog. have fun.";
    public static final String footerICP = "浙ICP备 xxxxxx-x号";
    public static final String footerCopyRight = "@2018 James   ";
