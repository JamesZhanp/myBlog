...
import com.james.myblog.config.Constants;
...
public class UploadController {
    ...
    @ResponseBody
    public Result upload(HttpServletRequest httpServletRequest, @RequestParam("file")MultipartFile file) throws IOException, URISyntaxException{
